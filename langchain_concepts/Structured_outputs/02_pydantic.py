...
class Review(BaseModel):
    key_themes : list[str] = Field(description = 'Write down all the key theme discussed in the review in the list')
    ...
    sentiment : str = Field(description=  'Return sentiment of the review either postive . negative , neutral')
